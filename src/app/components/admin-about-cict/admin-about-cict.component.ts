...
@Component({
  selector: 'app-admin-about-cict',
  templateUrl: './admin-about-cict.component.html',
  styleUrls: ['./admin-about-cict.component.css']
})
export class AdminAboutCictComponent implements OnInit {
  ...
  goToEditAboutCICT() {
    this.router.navigate(["EditAboutCICT"]);
