...
@Component({
  selector: 'app-student-about-workonit',
  templateUrl: './student-about-workonit.component.html',
  styleUrls: ['./student-about-workonit.component.css']
})
export class StudentAboutWorkonitComponent implements OnInit {
