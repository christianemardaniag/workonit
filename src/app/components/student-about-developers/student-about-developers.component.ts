...
@Component({
  selector: 'app-student-about-developers',
  templateUrl: './student-about-developers.component.html',
  styleUrls: ['./student-about-developers.component.css']
})
export class StudentAboutDevelopersComponent implements OnInit {

  constructor(public db: DbhelperService,public toast: HotToastService, public router: Router, public dialogRef:MatDialog) { }
  developers: any;
  ngOnInit(): void {
