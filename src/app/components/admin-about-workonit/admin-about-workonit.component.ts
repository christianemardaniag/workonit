...
@Component({
  selector: 'app-admin-about-workonit',
  templateUrl: './admin-about-workonit.component.html',
  styleUrls: ['./admin-about-workonit.component.css']
})
export class AdminAboutWorkonitComponent implements OnInit {
  ...
  goToEditAboutWorkOnIt() {
    this.router.navigate(["/EditAboutWorkOnIt"]);
  }
